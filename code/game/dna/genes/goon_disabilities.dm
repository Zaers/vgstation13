...
/datum/dna/gene/disability/mute/activate(var/mob/M, var/connected, var/flags)
	..()
	M.sdisabilities |= MUTE

/datum/dna/gene/disability/mute/deactivate(var/mob/M, var/connected, var/flags)
	if(..())
		M.sdisabilities &= ~MUTE
////////////////////////////////////////
...
/datum/dna/gene/disability/radioactive/OnMobLife(var/mob/owner)
	if(owner.radiation < 20)
		owner.radiation += 5 //Bypass protection, and also go a bit over 20 so damage can actually be applied
...
/datum/dna/gene/disability/speech/smile/New()
	..()
	block=SMILEBLOCK

/datum/dna/gene/disability/speech/smile/OnSay(var/mob/M, var/datum/speech/speech)
...
/datum/dna/gene/disability/speech/elvis/New()
	..()
	block=ELVISBLOCK

/datum/dna/gene/disability/speech/elvis/OnSay(var/mob/M, var/datum/speech/speech)
	if(prob(5))
...
/datum/dna/gene/disability/speech/elvis/OnMobLife(var/mob/M)
	switch(pick(1,2))
		if(1)
			if(prob(15))
...
/datum/dna/gene/disability/speech/chav/OnSay(var/mob/M, var/datum/speech/speech)
...
/datum/dna/gene/disability/speech/swedish/OnSay(var/mob/M, var/datum/speech/speech)
	// svedish!
